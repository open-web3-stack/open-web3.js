...
export function formatType(
  ...
  switch (typeDef.info) {
    ...
    case TypeDefInfo.Tuple: {
      ...
      return formatTuple((typeDef.sub as TypeDef[]).map((sub): string => formatType(definitions, sub.type, imports)));
    }
    ...
    case TypeDefInfo.BTreeMap: {
      ...
      return formatBTreeMap(
        formatType(definitions, keyDef.type, imports),
        formatType(definitions, valDef.type, imports)
      );
    }
    ...
    case TypeDefInfo.Result: {
      ...
      return formatResult(
        formatType(definitions, okDef.type, imports),
        formatType(definitions, errorDef.type, imports)
      );
    }
